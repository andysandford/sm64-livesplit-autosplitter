# How to use:  
Download the file called [`LiveSplit.SM64.asl`](https://raw.githubusercontent.com/andysandford/sm64-livesplit-autosplitter/main/LiveSplit.SM64.asl). Edit your LiveSplit layout and add the `Scriptable Auto Splitter` component.  
